...
SCENARIOS.startup = {
    ...
    steps: [
        ...
        { from: 'mediator',       to: 'mediator',       label: 'history = []\ncurrentViewId = OpeningOpening\npendingViewId = OpeningOpening', kind: 'self',
          setState: { mediator: { current: 'OpeningOpening', pending: 'OpeningOpening', history: '[]' } } },
        ...
        { from: 'mediator',       to: 'mediator',       label: 'history.push(OpeningOpening)\npreviousViewId = OpeningOpening\ncurrentViewId = NormalHome', kind: 'self',
          setState: { mediator: { current: 'NormalHome', prev: 'OpeningOpening', history: '[OpeningOpening]' } } },
